...
def draw_fuel_display(surface, center, radius, fuel_level, average_fuel_per_lap):
    ...
    text_rect = fuel_text.get_rect(center=(center[0], center[1] - 15))
    surface.blit(fuel_text, text_rect)

    average_fuel_text = font.render(f"5L Avg: {average_fuel_per_lap:.1f}", True, (255, 230, 255))
    average_text_rect = average_fuel_text.get_rect(center=center)
...
while running:
    ...
    try:
        ...
        throttle_percentage = brake_percentage = fuel_level = lap_number = 0.0
