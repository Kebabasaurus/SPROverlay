...
while running:
    ...
    lap_time_text = font.render(f"Last Lap: {format_time(lap_time)}", True, (225, 155, 255))  # Purple for lap time
    ...
    precipitation_text = font_small.render(f"P: {precipitation*100:.2f}%", True, (255, 255, 255))
    track_wetness_text = font_small.render(f"TW: {track_wetness:.1f}", True, (255, 255, 255))

# Change ABS text color based on its state
    abs_color = (187, 255, 0) if BrakeABSactive == 1 else (255, 255, 255)
