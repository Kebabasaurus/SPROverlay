...
while running:
    ...
    track_temp_text = font_weather.render(f"TT: {track_temp:.1f}°C", True, (255, 99, 229))
    precipitation_text = font_weather.render(f"P: {precipitation*100:.2f}%", True, (255, 99, 229))
    track_wetness_text = font_weather.render(f"TW: {track_wetness:.1f}", True, (255, 99, 229))

# Change ABS text color based on its state
    abs_color = (187, 255, 0) if BrakeABSactive == 1 else (255, 99, 229)
