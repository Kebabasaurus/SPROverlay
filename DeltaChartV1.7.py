...
"""
    if not os.path.exists(file_path):
        ...
        print(f"Default settings created at {file_path}")
...
# Extract settings
window_x = settings.get('Deltax', 50)
window_y = settings.get('Deltay', 30)
...
button_width, button_height = 20, 40
...
while running:
    ...
    try:
        ...
        lap_delta_to_best_lap = ir['LapDeltaToSessionBestLap']
